...
@Component({
  selector: 'app-afin',
  templateUrl: './afin.page.html',
  styleUrls: ['./afin.page.scss'],
})
export class AfinPage implements  OnDestroy {


  private sonidoFondo: HTMLAudioElement | null = null;
  cursoGrado: string = ''; // Declaración de la propiedad cursoGrado
  redirectRoute: string = '/levels'; // Propiedad para almacenar la ruta de redirección
