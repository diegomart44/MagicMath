...
@Component({
  selector: 'app-aplay',
  templateUrl: 'aplay.page.html',
  styleUrls: ['aplay.page.scss'],
})
export class AplayPage implements OnDestroy {

  private sonidoFondo: HTMLAudioElement | null = null;
  cursoGrado: string = ''; // Declaración de la propiedad cursoGrado
  redirectRoute: string = '/levels/a'; // Propiedad para almacenar la ruta de redirección
